...
motions.push(new Motion("color_normal","Panel de color normal",['normal','defecto']))
motions.push(new Motion("color_rojo","Panel de color rojo",['rojo','colorado']))
motions.push(new Motion("color_verde","Panel de color verde",['verde']))
motions.push(new Motion("color_azul","Panel de color azul",['azul','ashul','ayul',' asul ','azulado',' asulado ']))
motions.push(new Motion("color_blanco","Panel de color blanco",['blanco']))
motions.push(new Motion("color_negro","Panel de color negro",['negro']))
...
motions.push(new Motion("color_amarillo","Panel de color amarillo",['amarillo']))
motions.push(new Motion("color_violeta","Panel de color violeta",['violeta','violetta']))
motions.push(new Motion("color_gris","Panel de color gris",['gris',' gray ',' grai ']))
motions.push(new Motion("color_rosa","Panel de color rosa",['rosa','rosado']))
motions.push(new Motion("color_marron","Panel de color marron",['marron']))
motions.push(new Motion("color_naranja","Panel de color naranja",['naranja','anaranjado']))
motions.push(new Motion("color_beige","Panel de color beige",['beige','beish']))
motions.push(new Motion("color_celeste","Panel de color celeste",['celeste']))
motions.push(new Motion("color_purpura","Panel de color purpura",['purpura']))
motions.push(new Motion("color_lavanda","Panel de color lavanda",['lavanda','labanda']))
motions.push(new Motion("color_oliva","Panel de color oliva",['oliva','oliba','olivo','aceituna','tutuna']))
motions.push(new Motion("color_turquesa","Panel de color turquesa",['turqueza','turquesa','turkesa','turqueza']))
