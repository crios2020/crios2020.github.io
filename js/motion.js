...
motions.push(new Motion("economia","¿Información Financiera?",['dólar','dolar','euro','blu','blue','mercado','finaciera','bursátil']))
...
fps.push(new Motion("programacion","¿Puedo ser programador?",['programador','programacion','programación','software','desarrollo','java','base']))
...
fps.push(new Motion("datos","¿Estudiar Análisis de datos?",['análisis','analista','datos','estadística','inteligencia','negocio']))
